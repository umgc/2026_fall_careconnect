...
ALTER TABLE users
    ADD COLUMN IF NOT EXISTS address_place_id VARCHAR (255);
ALTER TABLE users
    ADD COLUMN IF NOT EXISTS address_formatted TEXT;
ALTER TABLE users
    ADD COLUMN IF NOT EXISTS address_latitude NUMERIC (10, 8);
ALTER TABLE users
    ADD COLUMN IF NOT EXISTS address_longitude NUMERIC (11, 8);
