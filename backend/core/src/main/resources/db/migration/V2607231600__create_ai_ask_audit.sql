-- Flyway twin of db/schema-patches/2607231600_create_ai_ask_audit.sql
-- Ask AI FR-AI-10 / REQ-SC-9 audit ledger.
...
(
    ...
    CONSTRAINT uq_ai_ask_audit_event_seq UNIQUE
(
    audit_id,
    event_sequence
)
