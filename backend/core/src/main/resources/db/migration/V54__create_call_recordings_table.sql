...
(
    ...
    concatenation_pipeline_id VARCHAR
(
    255
),
    concatenation_status VARCHAR
(
    30
),
    error_message TEXT,
...
CREATE INDEX IF NOT EXISTS idx_call_recordings_concat_status ON call_recordings(concatenation_status);
