...
DELETE
FROM plan
WHERE code IN ('plan_SbkhH3AATKabKy', 'plan_SbkhIoC5wy5iwB');

-- Insert Standard Plan
INSERT INTO plan (code, name, price_cents, billing_period, is_active)
VALUES ('plan_SbkhH3AATKabKy', 'Standard Plan', 2000, 'MONTH', TRUE) ON CONFLICT (code) DO NOTHING;

-- Insert Premium Plan
INSERT INTO plan (code, name, price_cents, billing_period, is_active)
VALUES ('plan_SbkhIoC5wy5iwB', 'Premium Plan', 3000, 'MONTH', TRUE) ON CONFLICT (code) DO NOTHING;
...
INSERT INTO plan (code, name, price_cents, billing_period, is_active)
VALUES ('price_1RmqWxELoozGI1YxQql5rsvN', 'Premium Plan', 3000, 'MONTH', TRUE) ON CONFLICT (code) DO NOTHING;
