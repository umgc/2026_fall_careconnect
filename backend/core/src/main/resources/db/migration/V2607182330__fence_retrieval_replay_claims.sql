...
ALTER TABLE call_sessions
    ADD CONSTRAINT fk_call_sessions_patient
        FOREIGN KEY (patient_id) REFERENCES patient (id);
END IF;
    IF
NOT EXISTS (SELECT 1 FROM pg_constraint c
...
ALTER TABLE call_sessions
    ADD CONSTRAINT fk_call_sessions_created_by
...
ALTER TABLE call_participants
    ADD CONSTRAINT fk_call_participants_session
...
ALTER TABLE call_participants
    ADD CONSTRAINT fk_call_participants_invited_by
...
COMMENT
ON COLUMN retrieval_index_chunk.citation_replay_claim_token IS
