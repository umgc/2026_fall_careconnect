...
(
    ...
    CONSTRAINT ck_transcript_archive_generation CHECK
(
    generation
    >=
    0
...
(
    ...
    CONSTRAINT uq_transcript_archive_deletion_key UNIQUE
(
    storage_key
),
    CONSTRAINT ck_transcript_archive_deletion_attempts CHECK
(
    attempts
    >=
    0
