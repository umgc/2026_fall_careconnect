...
UPDATE retrieval_index_chunk
SET citation_replay_attempts = 0
...
ALTER
COLUMN indexed_at SET DEFAULT now(),
    ALTER
COLUMN citation_replay_attempts SET DEFAULT 0,
    ALTER
COLUMN migration_status SET DEFAULT 'ACTIVE';
...
ALTER TABLE retrieval_index_chunk
DROP
CONSTRAINT IF EXISTS ck_retrieval_id_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_patient_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_record_type_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_source_record_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_chunk_text_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_indexed_at_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_attempts_nn,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_status_nn;
...
COLUMN patient_id SET NOT NULL,
    ALTER
COLUMN record_type SET NOT NULL,
    ALTER
COLUMN source_record_id SET NOT NULL,
    ALTER
COLUMN chunk_text SET NOT NULL,
    ALTER
COLUMN indexed_at SET NOT NULL,
    ALTER
COLUMN citation_replay_attempts SET NOT NULL,
    ALTER
COLUMN migration_status SET NOT NULL;

ALTER TABLE retrieval_index_chunk
DROP
CONSTRAINT ck_retrieval_id_nn,
    DROP
CONSTRAINT ck_retrieval_patient_nn,
    DROP
CONSTRAINT ck_retrieval_record_type_nn,
    DROP
CONSTRAINT ck_retrieval_source_record_nn,
    DROP
CONSTRAINT ck_retrieval_chunk_text_nn,
    DROP
CONSTRAINT ck_retrieval_indexed_at_nn,
    DROP
CONSTRAINT ck_retrieval_attempts_nn,
    DROP
CONSTRAINT ck_retrieval_status_nn;

-- Plain statements only: SchemaPatchLedger/ScriptUtils splits on ';' and cannot
-- execute Postgres dollar-quoted anonymous blocks.
ALTER TABLE retrieval_index_chunk
DROP
CONSTRAINT IF EXISTS retrieval_index_chunk_pkey;
ALTER TABLE retrieval_index_chunk
...
COLUMN created_at SET DEFAULT now(),
    ALTER
COLUMN updated_at SET DEFAULT now(),
    ALTER
COLUMN patient_id SET NOT NULL,
    ALTER
COLUMN source_kind SET NOT NULL,
    ALTER
COLUMN source_record_id SET NOT NULL,
    ALTER
COLUMN attempts SET NOT NULL,
    ALTER
COLUMN migration_status SET NOT NULL,
    ALTER
...
ALTER TABLE summary_citation_replay_source
DROP
CONSTRAINT IF EXISTS ck_summary_replay_status,
    DROP
CONSTRAINT IF EXISTS ck_summary_replay_attempts,
    DROP
CONSTRAINT IF EXISTS ck_summary_replay_source_kind,
    DROP
CONSTRAINT IF EXISTS ck_summary_replay_lease_token;
...
ALTER TABLE summary_citation_replay_source
DROP
CONSTRAINT IF EXISTS pk_summary_citation_replay_source;
ALTER TABLE summary_citation_replay_source
...
ALTER TABLE summary_citation_replay_source
DROP
CONSTRAINT IF EXISTS fk_summary_replay_patient;
ALTER TABLE summary_citation_replay_source
...
INSERT INTO summary_citation_replay_source (patient_id, source_kind, source_record_id)
...
ALTER TABLE retrieval_index_chunk
DROP
CONSTRAINT IF EXISTS ck_retrieval_migration_status,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_replay_attempts,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_source_kind,
    DROP
CONSTRAINT IF EXISTS ck_retrieval_replay_lease_token;
