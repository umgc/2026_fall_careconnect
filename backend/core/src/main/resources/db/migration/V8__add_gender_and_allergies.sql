...
COMMENT
ON CONSTRAINT uk_family_member_link_unique ON family_member_link IS 'Prevents duplicate family member-patient links';
COMMENT
ON CONSTRAINT uk_family_member_link_patient_unique ON family_member_link IS 'Prevents duplicate family member-patient links using patient_id';
