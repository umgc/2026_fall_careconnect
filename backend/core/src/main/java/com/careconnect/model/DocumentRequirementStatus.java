...
public class DocumentRequirementStatus {
    ...
    public Long getStructuredEntryId() { return structuredEntryId; }
    ...
    public void setStructuredEntryId(Long structuredEntryId) { this.structuredEntryId = structuredEntryId; }
