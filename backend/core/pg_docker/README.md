...
These files are automatically mounted in the PostgreSQL container for reference but are applied by the Spring Boot
application or manual Flyway commands.
